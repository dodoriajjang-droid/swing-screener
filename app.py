...
# ==========================================
# 2. 통합 데이터 수집 & AI 함수 (순서 꼬임 방지 최상단 배치)
# ==========================================
...
with tab0:
    ...
    with m_col2:
        ...
        fig_fg = draw_gauge(fg_data['score'], fg_data['score'] - fg_data['delta'], "<b>CNN 탐욕 지수</b>", steps_fg) if fg_data else draw_gauge(0,0,"CNN 공포/탐욕 지수", steps_fg, True)
